...
**
*******************************************************************************/
SDP_API extern BOOLEAN SDP_InitDiscoveryDb (tSDP_DISCOVERY_DB *p_db, uint32_t len,
                                            uint16_t num_uuid,
...
**
*******************************************************************************/
SDP_API extern BOOLEAN SDP_ServiceSearchAttributeRequest (uint8_t *p_bd_addr,
...
**
****************************************************************************/
SDP_API extern uint32_t SDP_CreateRecord (void);
...
**
*******************************************************************************/
SDP_API extern BOOLEAN SDP_DeleteRecord (uint32_t handle);
...
**
*******************************************************************************/
SDP_API extern INT32 SDP_ReadRecord(uint32_t handle, uint8_t *p_data, INT32 *p_data_len);
...
**
****************************************************************************/
SDP_API extern BOOLEAN SDP_AddAttribute (uint32_t handle, uint16_t attr_id,
...
**
*******************************************************************************/
SDP_API extern BOOLEAN SDP_AddSequence (uint32_t handle,  uint16_t attr_id,
...
**
****************************************************************************/
SDP_API extern BOOLEAN SDP_AddUuidSequence (uint32_t handle,  uint16_t attr_id,
...
**
****************************************************************************/
SDP_API extern BOOLEAN SDP_AddProtocolList (uint32_t handle, uint16_t num_elem,
...
**
*******************************************************************************/
SDP_API extern BOOLEAN SDP_AddAdditionProtoLists (uint32_t handle, uint16_t num_elem,
...
**
*******************************************************************************/
SDP_API extern BOOLEAN SDP_AddProfileDescriptorList (uint32_t handle,
                                                     uint16_t profile_uuid,
                                                     uint16_t version);
...
**
*******************************************************************************/
SDP_API extern BOOLEAN SDP_AddLanguageBaseAttrIDList (uint32_t handle,
...
**
****************************************************************************/
SDP_API extern BOOLEAN SDP_AddServiceClassIdList (uint32_t handle,
...
**
*******************************************************************************/
SDP_API extern BOOLEAN SDP_DeleteAttribute (uint32_t handle, uint16_t attr_id);
...
**
*******************************************************************************/
SDP_API extern uint16_t SDP_SetLocalDiRecord (tSDP_DI_RECORD *device_info,
                                            uint32_t *p_handle);
...
**
*******************************************************************************/
SDP_API extern uint16_t SDP_GetLocalDiRecord(tSDP_DI_GET_RECORD *p_device_info,
                                           uint32_t *p_handle );
...
**
*******************************************************************************/
SDP_API extern uint16_t SDP_DiDiscover (BD_ADDR remote_device,
...
**
*******************************************************************************/
SDP_API extern uint8_t  SDP_GetNumDiRecords (tSDP_DISCOVERY_DB *p_db);
...
**
*******************************************************************************/
SDP_API extern uint16_t SDP_GetDiRecord (uint8_t getRecordIndex,
...
**
*******************************************************************************/
SDP_API extern uint8_t SDP_SetTraceLevel (uint8_t new_level);
...
**
*******************************************************************************/
SDP_API uint32_t SDP_ConnOpen (uint8_t *p_bd_addr, tSDP_DISC_RES_CB *p_rcb,
                                  tSDP_DISC_CMPL_CB *p_cb);
...
**
*******************************************************************************/
SDP_API BOOLEAN SDP_WriteData (uint32_t handle, BT_HDR  *p_msg);
...
**
*******************************************************************************/
SDP_API BOOLEAN SDP_ConnClose (uint32_t handle);
